        ...
        <section className="ai-motion-section">
                ...
                <div className="ai-motion-camera">
                    <div className="ai-motion-camera-inner">
                        ...
                        {camStatus === "active" && isPlank && plankPhase !== "idle" && (
                            <div className={`ai-motion-plank-phase-badge plank-badge--${plankPhase}`}>
                                {plankPhase === "running"
                                    ? `⏱ ${formatDur(plankDuration)}`
                                    : `🏆 ${formatDur(plankDuration)}`}
                            </div>
                        )}
            ...
            <div className="ai-motion-note">
                ...
                <span>
                    ...
                    {isPlank && " Mode Plank: 👍 acungkan jempol untuk mulai, ✋ buka 5 jari untuk berhenti."}
                </span>
            </div>
        </section>
    );
